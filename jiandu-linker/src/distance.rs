...
impl GrammarDistance {
    pub fn new() -> Self {
        ...
        let mut category_distance = vec![vec![1.0; n]; n];

        for i in 0..n {
            category_distance[i][i] = 0.0;
        }

        category_distance[0][6] = 0.3;
        category_distance[6][0] = 0.3;
        category_distance[2][3] = 0.4;
        category_distance[3][2] = 0.4;
        category_distance[7][8] = 0.2;
        category_distance[8][7] = 0.2;
        category_distance[9][10] = 0.3;
        category_distance[10][9] = 0.3;
